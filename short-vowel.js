...
class ShortVowelQS {
    static FLAGS = ["wrong", "close_tanween", "close_shadda", "correct"]
    ...
    constructor(data) {
        ...
        for (let i = 0; i < skeleton_letters.length; ++i) {
            ...
            if (this.data.answerLP[i].svowel) {
                letter = new Letter(sk_letter, this, ShortVowelQV._onLetterClick);
            }
            else {
                letter = new Letter(sk_letter, this);
            }
            this.HTML.skeleton.appendChild(letter.getRootHTML());
        ...
        this.submitButton = new SubmitButton(ShortVowelQV._onSubmitClick);
        this.submitButton.view = this;
        this.submitButton.keyboard = this.keyboard;
